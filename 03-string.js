...
console.log(s1.substring(7));   //  7번 인덱스 ~ 
...
//  검색 시작 위치 조정
position += 4;
position = s1.indexOf("Java", position);    //  s1에서 Java 검색 시작 위치 설정
console.log("2nd search:", position);

position = s1.indexOf("java");  // 없는 키워드 겁색
...
console.log("TRIM:", "               Hellow, JavaScript            ".trim());   //  좌우 공백 제거

// String 추가 내용
// 이스케이프 문자: 측수 문자를 부여할 수 있다
//      \n: 개행
//      \t: 탭
//      \': 작은 따옴표
//      \": 큰 따옴표
